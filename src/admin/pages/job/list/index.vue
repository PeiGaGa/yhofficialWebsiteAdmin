<template>
  <div>
    <div class="page overflow-y"  v-if="$route.path=='/job/list'">
        <div class="task clearfix">
            ...
            <div class="fr">
                <router-link tag="button" class="btn btn-ok" to="/job/list/add">新增</router-link>
            </div>
        </div>
        <table class="table-list-1">
            ...
            <tr v-for="(item, index) in list.content">
                ...
                <td>
                    <router-link tag="button" :to="{name: 'jobListEdit', params: {id: item.id}}" type="button" class="table-btn btn-ok">修改</router-link>
