...
Axis.prototype = {
	...
	setAxisSize: function () {
		...
		// Expose index values to use in Series object and navigator
...
var ColumnSeries = extendClass(Series, {
	...
	/**
	 * Override the index data label alignment by adjusting for the position of the column
	 */
	alignDataLabel: function (point, dataLabel, options,  alignTo, isNew) {
		var chart = this.chart,
			inverted = chart.inverted,
...
var PieSeries = {
	...
	/**
	 * Extend the index setData method by running processData and generatePoints immediately,
