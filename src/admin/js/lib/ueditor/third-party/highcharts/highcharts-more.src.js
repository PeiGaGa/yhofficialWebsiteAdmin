 ...
 *
 * In the future, this can be extended to index Highcharts and Highstock.
 */
...
seriesTypes.arearange = Highcharts.extendClass(seriesTypes.area, {
	...
	/**
	 * Extend the index drawDataLabels method by running it for both lower and higher
	 * values.
	 */
...
function polarAnimate(proceed, init) {
	...
	// For non-polar charts, revert to the index animation
	} else {
