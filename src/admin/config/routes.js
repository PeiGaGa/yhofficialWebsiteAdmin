...
export default [
  {
    ...
    children: [
      ...
      //关于我们
      {
        ...
        children: [
          //基础设置
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/about/basic/index.vue')), 'about-basic')),
          },
          //轮播图设置
          {
            path: 'banner',
            ...
            component: (r => require.ensure([], () => r(require('../pages/about/banner/index.vue')), 'about')),
          },
          // 企业简介
          {
            path: 'introduce',
            ...
            component: (r => require.ensure([], () => r(require('../pages/about/introduction/index.vue')), 'about')),
          },
          //新闻
          {
            path: 'news',
            ...
            component: (r => require.ensure([], () => r(require('../pages/about/news/index.vue')), 'news')),
            children: [
              {
                path: 'basic',
                name: 'news_basic',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/news/basic.vue')), 'news'))
              },
              {
                path: 'menu',
                name: 'news_menu',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/news/menu/index.vue')), 'news')),
                children: [
                  {
                    path: 'edit',
                    name: 'newsMenuEdit',
                    ...
                    component: (r => require.ensure([], () => r(require('../pages/about/news/menu/edit.vue')), 'news'))
                  }
                ]
              },
              {
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/news/list.vue')), 'news')),
                children: [
                  {
                    path: 'add',
                    name: 'news_add',
                    ...
                    component: (r => require.ensure([], () => r(require('../pages/about/news/add.vue')), 'news'))
                  }
                  ,
                  {
                    path: 'edit',
                    ...
                    component: (r => require.ensure([], () => r(require('../pages/about/news/edit.vue')), 'news'))
                  }
                ]
              },
            ]
          ...
          // // 管理团队及专家介绍
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/about/expert/index.vue')), 'about')),
            children: [
              {
                path: 'basic',
                name: 'export_basic',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/expert/basic.vue')), 'expert'))
              },
              {
                path: 'add',
                name: 'export_add',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/expert/add.vue')), 'expert'))
              },
              // 管理团队及专家介绍
              {
                path: 'edit',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/expert/edit.vue')), 'expert'))
              }
            ]
          },
          // 荣誉资质
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/about/honor/honor.vue')), 'honor1')),
            children: [
              {
                path: 'basic',
                name: 'honor_basic',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/honor/basic.vue')), 'honor1'))
              },]
          },
          ...
          // 深潜
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/about/deepfocus/index.vue')), 'about')),
            children: [
              {
                path: 'basic',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/deepfocus/basic.vue')), 'about_deepfocus'))
              }
            ]
          },
          // 全球布局和合作联盟
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/about/partner/partner.vue')), 'about_partner')),
            children: [
              {
                path: 'basic',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/partner/basic.vue')), 'about_partner'))
              }]
          },
          // 企业责任
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/about/responsibility/index.vue')), 'about')),
            children: [
              {
                path: 'basic',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/responsibility/basic.vue')), 'about'))
              },
              {
                path: 'edit',
                ...
                component: (r => require.ensure([], () => r(require('../pages/about/responsibility/edit.vue')), 'about')),
              }
            ]
          },
          // //企业文化
       ...
       // 养殖模式
       {
        ...
        component: (r => require.ensure([], () => r(require('../pages/breeding/index.vue')), 'breeding')),
        children: [
          {
            path: 'basic',
            name: 'breeding_basic',
            ...
            component: (r => require.ensure([], () => r(require('../pages/breeding/basic/basic.vue')), 'breeding')),
          },
          //轮播图设置
          {
            path: 'banner',
            ...
            component: (r => require.ensure([], () => r(require('../pages/breeding/banner/index.vue')), 'breeding')),
          },
          // 陆基苗种基地
          {
            path: 'landbase',
            ...
            component: (r => require.ensure([], () => r(require('../pages/breeding/landbase/basic.vue')), 'breeding')),
          },
          // 深远海养殖
          {
            path: 'deepsea',
            ...
            component: (r => require.ensure([], () => r(require('../pages/breeding/deepsea/basic.vue')), 'breeding')),
          }
        ]
      },
      // 科研优势
      {
        ...
        children: [
          ...
          // 组学研究
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/advantage/ecological/index.vue')), 'advantage')), children: [
              {
                path: 'add',
                name: 'ecological_add',
                meta: {
          ...
          //论著
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/advantage/book/index.vue')), 'book')),
            children: [
              {
                path: 'basic',
                name: 'book_basic',
                ...
                component: (r => require.ensure([], () => r(require('../pages/advantage/book/basic.vue')), 'book'))
              },
              {
                path: 'edit',
                name: 'book_edit',
                ...
                component: (r => require.ensure([], () => r(require('../pages/advantage/book/edit.vue')), 'book'))
              }
            ]
          },
          // 水生生物生物制药
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/advantage/data/index.vue')), 'advantage')),
            children: [
              {
                path: 'basic',
                ...
                component: (r => require.ensure([], () => r(require('../pages/advantage/data/basic/basic.vue')), 'advantage'))
              },
              {
                path: 'bigdata',
                ...
                component: (r => require.ensure([], () => r(require('../pages/advantage/data/bigdata/index.vue')), 'advantage'))
              },
              {
                path: 'thousand_fish',
                name: 'thousand_fish',
                ...
                component: (r => require.ensure([], () => r(require('../pages/commonModel/class/classContent.vue')), 'advantage'))
              },
              {
                path: 'breeding_plan',
                name: 'breeding_plan',
      ...
      //生物制药
      {
        ...
        component: (r => require.ensure([], () => r(require('../pages/pharmacy/index.vue')), 'pharmacy')),
        children: [
          // 基本设置
          {
            path: 'basic',
            ...
            component: (r => require.ensure([], () => r(require('../pages/pharmacy/basic/basic.vue')), 'pharmacy')),
          },
          // 轮播图
          {
            path: 'banner',
            ...
            component: (r => require.ensure([], () => r(require('../pages/pharmacy/banner/index.vue')), 'pharmacy')),
          },
          {
            path: 'masterplan',
            ...
            component: (r => require.ensure([], () => r(require('../pages/commonModel/class/classContent.vue')), 'pharmacy')),
          },
          {
      ...
      //  加入我们
      {
        ...
        component: (r => require.ensure([], () => r(require('../pages/joinus/index.vue')), 'joinus')),
        children: [
          {
            path: 'basic',
            name: 'joinus_basic',
            ...
            component: (r => require.ensure([], () => r(require('../pages/joinus/basic/basic.vue')), 'data')),
          },
          {
            path: 'banner',
            name: 'joinus_banner',
            ...
            component: (r => require.ensure([], () => r(require('../pages/joinus/banner/index.vue')), 'joinus')),
          },
      ...
      // 工作
      {
        ...
        children: [
          ...
          //社会招聘设置
          {
            ...
            component: (r => require.ensure([], () => r(require('../pages/job/basic/basic.vue')), 'job'))
          },
          {
            path: 'basic-1',
            name: 'job_basic-1',
      ...
      },// 内部链接
      {
        ...
        component: (r => require.ensure([], () => r(require('../pages/inlink/index.vue')), 'inlink')),
        children: [
          {
            path: 'edit',
            name: 'inlink_edit',
            ...
            component: (r => require.ensure([], () => r(require('../pages/inlink/edit.vue')), 'inlink')),
          }, {
            path: 'add',
            name: 'inlink_add',
            meta: {
            ...
            component: (r => require.ensure([], () => r(require('../pages/inlink/add.vue')), 'inlink')),
          }
        ]
      }
    ]
